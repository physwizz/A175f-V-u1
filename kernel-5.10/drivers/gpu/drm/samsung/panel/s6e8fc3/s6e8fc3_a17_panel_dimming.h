/*
 * linux/drivers/video/fbdev/exynos/panel/s6e8fc3/s6e8fc3_a17_panel_dimming.h
 *
...
#ifndef __S6E8FC3_A17_PANEL_DIMMING_H___
#define __S6E8FC3_A17_PANEL_DIMMING_H___
#include "../dimming.h"
 ...
 * PANEL : PRE
 */
#define S6E8FC3_A17_NR_STEP (S6E8FC3_A17_NR_LUMINANCE)
#define S6E8FC3_A17_HBM_STEP (S6E8FC3_A17_NR_HBM_LUMINANCE)
#define S6E8FC3_A17_TOTAL_STEP (S6E8FC3_A17_NR_STEP + S6E8FC3_A17_HBM_STEP)

static unsigned int a17_brt_tbl[S6E8FC3_A17_TOTAL_STEP] = {
...
static unsigned int a17_lum_tbl[S6E8FC3_A17_TOTAL_NR_LUMINANCE] = {
	/* normal 10x25 + 6 */
	2, 2, 2, 3, 3, 4, 5, 5, 6, 7,
...
static unsigned int a17_step_cnt_tbl[S6E8FC3_A17_TOTAL_STEP] = {
	[0 ... S6E8FC3_A17_TOTAL_STEP - 1] = 1,
};

static struct brightness_table s6e8fc3_a17_panel_brightness_table = {
	.control_type = BRIGHTNESS_CONTROL_TYPE_GAMMA_MODE2,
	.brt = a17_brt_tbl,
	.sz_brt = ARRAY_SIZE(a17_brt_tbl),
	.sz_ui_brt = S6E8FC3_A17_NR_STEP,
	.sz_hbm_brt = S6E8FC3_A17_HBM_STEP,
	.lum = a17_lum_tbl,
	.sz_lum = S6E8FC3_A17_TOTAL_NR_LUMINANCE,
	.sz_ui_lum = S6E8FC3_A17_NR_LUMINANCE,
	.sz_hbm_lum = S6E8FC3_A17_NR_HBM_LUMINANCE,
	.sz_ext_hbm_lum = 0,
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
...
static struct panel_dimming_info s6e8fc3_a17_panel_dimming_info = {
	.name = "s6e8fc3_a17",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &s6e8fc3_a17_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,
	.hbm_aor = NULL,
