/*
 * linux/drivers/video/fbdev/exynos/panel/s6e8fc3/s6e8fc3_a17_aod_panel.h
 *
...
#ifndef __S6E8FC3_A17_AOD_PANEL_H__
#define __S6E8FC3_A17_AOD_PANEL_H__

#include "oled_common_aod.h"
#include "s6e8fc3_a17_self_mask_img.h"
#include "s6e8fc3_aod.h"

#define S6E8FC3_A17SELF_MASK_VALID_CRC_1 (0x35)
#define S6E8FC3_A17SELF_MASK_VALID_CRC_2 (0xF6)

static u8 s6e8fc3_a17_self_mask_crc[] = {
	S6E8FC3_A17SELF_MASK_VALID_CRC_1,
	S6E8FC3_A17SELF_MASK_VALID_CRC_2,
};
...
static void *s6e8fc3_a17_aod_self_mask_ena_cmdtbl[] = {
...
static void *s6e8fc3_a17_aod_self_mask_dis_cmdtbl[] = {
	&KEYINFO(s6e8fc3_aod_l2_key_enable),
...
// --------------------- check sum control ----------------------------
static DEFINE_STATIC_PACKET_WITH_OPTION(s6e8fc3_a17_aod_self_mask_img_pkt,
		DSI_PKT_TYPE_WR_SR, S6E8FC3_A17_SELF_MASK_IMG, 0, PKT_OPTION_SR_ALIGN_16);
...
static void *s6e8fc3_a17_aod_self_mask_crc_cmdtbl[] = {
	...
	&PKTINFO(s6e8fc3_a17_aod_self_mask_img_pkt),
...
static void *s6e8fc3_a17_aod_self_mask_img_cmdtbl[] = {
	&KEYINFO(s6e8fc3_aod_l2_key_enable),
	&PKTINFO(s6e8fc3_aod_self_mask_sd_path_1),
	&PKTINFO(s6e8fc3_aod_self_mask_sd_path_2),
...
static struct seqinfo s6e8fc3_a17_aod_seqtbl[] = {
	SEQINFO_INIT(SELF_MASK_IMG_SEQ, s6e8fc3_a17_aod_self_mask_img_cmdtbl),
	SEQINFO_INIT(SELF_MASK_ENA_SEQ, s6e8fc3_a17_aod_self_mask_ena_cmdtbl),
	SEQINFO_INIT(SELF_MASK_DIS_SEQ, s6e8fc3_a17_aod_self_mask_dis_cmdtbl),
	SEQINFO_INIT(SELF_MASK_CRC_SEQ, s6e8fc3_a17_aod_self_mask_crc_cmdtbl),
};

static struct aod_tune s6e8fc3_a17_aod = {
	.name = "s6e8fc3_a17_aod",
	.nr_seqtbl = ARRAY_SIZE(s6e8fc3_a17_aod_seqtbl),
	.seqtbl = s6e8fc3_a17_aod_seqtbl,
	.nr_maptbl = ARRAY_SIZE(s6e8fc3_aod_maptbl),
	.maptbl = s6e8fc3_aod_maptbl,
	.self_mask_en = true,
	.self_mask_crc = s6e8fc3_a17_self_mask_crc,
	.self_mask_crc_len = ARRAY_SIZE(s6e8fc3_a17_self_mask_crc),
};
#endif
