/*
 * linux/drivers/video/fbdev/exynos/panel/db7f2010b/db7f2010b_a17_panel_dimming.h
 *
...
#ifndef __DB7F2010B_A17_PANEL_DIMMING_H___
#define __DB7F2010B_A17_PANEL_DIMMING_H___
#include "../dimming.h"
 ...
 * PANEL : PRE
 */
#define DB7F2010B_A17_NR_STEP (DB7F2010B_A17_NR_LUMINANCE)
#define DB7F2010B_A17_HBM_STEP (DB7F2010B_A17_NR_HBM_LUMINANCE)
#define DB7F2010B_A17_TOTAL_STEP (DB7F2010B_A17_NR_STEP + DB7F2010B_A17_HBM_STEP)

static unsigned int a17_brt_tbl[DB7F2010B_A17_TOTAL_STEP] = {
...
static unsigned int a17_lum_tbl[DB7F2010B_A17_TOTAL_NR_LUMINANCE] = {
	/* normal 10x25 + 6 */
	2, 2, 2, 3, 3, 4, 5, 5, 6, 7,
...
static unsigned int a17_step_cnt_tbl[DB7F2010B_A17_TOTAL_STEP] = {
	[0 ... DB7F2010B_A17_TOTAL_STEP - 1] = 1,
};

static struct brightness_table db7f2010b_a17_panel_brightness_table = {
	.control_type = BRIGHTNESS_CONTROL_TYPE_GAMMA_MODE2,
	.brt = a17_brt_tbl,
	.sz_brt = ARRAY_SIZE(a17_brt_tbl),
	.sz_ui_brt = DB7F2010B_A17_NR_STEP,
	.sz_hbm_brt = DB7F2010B_A17_HBM_STEP,
	.lum = a17_lum_tbl,
	.sz_lum = DB7F2010B_A17_TOTAL_NR_LUMINANCE,
	.sz_ui_lum = DB7F2010B_A17_NR_LUMINANCE,
	.sz_hbm_lum = DB7F2010B_A17_NR_HBM_LUMINANCE,
	.sz_ext_hbm_lum = 0,
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = a17_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(a17_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info db7f2010b_a17_panel_dimming_info = {
	.name = "db7f2010b_a17",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &db7f2010b_a17_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,
	.hbm_aor = NULL,
