/*
 * linux/drivers/video/fbdev/exynos/panel/db7f2010b/db7f2010b_a17_aod_panel.h
 *
...
#ifndef __DB7F2010B_A17_AOD_PANEL_H__
#define __DB7F2010B_A17_AOD_PANEL_H__

#include "oled_common_aod.h"
#include "db7f2010b_a17_self_mask_img.h"
#include "db7f2010b_aod.h"

/* DEPRECATED: Please check "self_mask_crc_expects" */
#define DB7F2010B_A17SELF_MASK_VALID_CRC_1 (0x35)
#define DB7F2010B_A17SELF_MASK_VALID_CRC_2 (0xF6)

static u8 db7f2010b_a17_self_mask_crc[] = {
	DB7F2010B_A17SELF_MASK_VALID_CRC_1,
	DB7F2010B_A17SELF_MASK_VALID_CRC_2,
};
...
static DEFINE_RULE_BASED_COND(a17_cond_is_factory_selfmask,
		PANEL_PROPERTY_IS_FACTORY_MODE, EQ, 1);

static void *db7f2010b_a17_aod_self_mask_ena_cmdtbl[] = {
	&KEYINFO(db7f2010b_aod_l2_key_enable),
	&CONDINFO_IF(a17_cond_is_factory_selfmask),
		&PKTINFO(db7f2010b_aod_factory_self_mask_ctrl_ena),
	&CONDINFO_EL(a17_cond_is_factory_selfmask),
		&PKTINFO(db7f2010b_aod_self_mask_ctrl_ena),
	&CONDINFO_FI(a17_cond_is_factory_selfmask),
...
static void *db7f2010b_a17_aod_self_mask_dis_cmdtbl[] = {
	&KEYINFO(db7f2010b_aod_l2_key_enable),
...
// --------------------- check sum control ----------------------------
static DEFINE_STATIC_PACKET_WITH_OPTION(db7f2010b_a17_aod_self_mask_img_pkt,
		DSI_PKT_TYPE_WR_SR, DB7F2010B_A17_SELF_MASK_IMG, 0, PKT_OPTION_SR_ALIGN_16);
...
static void *db7f2010b_a17_aod_self_mask_crc_cmdtbl[] = {
	...
	&PKTINFO(db7f2010b_a17_aod_self_mask_img_pkt),
...
static void *db7f2010b_a17_aod_self_mask_img_cmdtbl[] = {
	&KEYINFO(db7f2010b_aod_l2_key_enable),
	&PKTINFO(db7f2010b_aod_self_mask_sd_path_1),
	&PKTINFO(db7f2010b_aod_self_mask_sd_path_2),
...
static struct seqinfo db7f2010b_a17_aod_seqtbl[] = {
	SEQINFO_INIT(SELF_MASK_IMG_SEQ, db7f2010b_a17_aod_self_mask_img_cmdtbl),
	SEQINFO_INIT(SELF_MASK_ENA_SEQ, db7f2010b_a17_aod_self_mask_ena_cmdtbl),
	SEQINFO_INIT(SELF_MASK_DIS_SEQ, db7f2010b_a17_aod_self_mask_dis_cmdtbl),
	SEQINFO_INIT(SELF_MASK_CRC_SEQ, db7f2010b_a17_aod_self_mask_crc_cmdtbl),
};

static struct aod_tune db7f2010b_a17_aod = {
	.name = "db7f2010b_a17_aod",
	.nr_seqtbl = ARRAY_SIZE(db7f2010b_a17_aod_seqtbl),
	.seqtbl = db7f2010b_a17_aod_seqtbl,
	.nr_maptbl = ARRAY_SIZE(db7f2010b_aod_maptbl),
	.maptbl = db7f2010b_aod_maptbl,
	.self_mask_en = true,
	.self_mask_crc = db7f2010b_a17_self_mask_crc,
	.self_mask_crc_len = ARRAY_SIZE(db7f2010b_a17_self_mask_crc),
};
#endif
