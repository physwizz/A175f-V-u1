...
static int panel_regulator_init(struct panel_device *panel, struct panel_regulator *regulator)
{
	if (!regulator)
		return -EINVAL;
...
static int panel_regulator_enable(struct panel_device *panel, struct panel_regulator *regulator)
{
	int ret = 0;
...
static int panel_regulator_disable(struct panel_device *panel, struct panel_regulator *regulator)
{
	int ret = 0;
...
static int panel_regulator_force_disable(struct panel_device *panel, struct panel_regulator *regulator)
{
	int ret;
...
static int panel_regulator_set_voltage(struct panel_device *panel, struct panel_regulator *regulator, int uV)
{
	int ret, cur_uV;
...
static int panel_regulator_set_current_limit(struct panel_device *panel, struct panel_regulator *regulator, int uA)
{
	int ret;
...
int panel_regulator_helper_init(struct panel_device *panel, struct panel_regulator *regulator)
{
	if (!regulator)
		return -EINVAL;

	return call_panel_regulator_func(panel, regulator, init);
}

int panel_regulator_helper_enable(struct panel_device *panel, struct panel_regulator *regulator)
{
	if (!regulator)
		return -EINVAL;

	return call_panel_regulator_func(panel, regulator, enable);
}

int panel_regulator_helper_disable(struct panel_device *panel, struct panel_regulator *regulator)
{
	if (!regulator)
		return -EINVAL;

	return call_panel_regulator_func(panel, regulator, disable);
}

int panel_regulator_helper_force_disable(struct panel_device *panel, struct panel_regulator *regulator)
{
	if (!regulator)
		return -EINVAL;

	return call_panel_regulator_func(panel, regulator, force_disable);
}

int panel_regulator_helper_set_voltage(struct panel_device *panel, struct panel_regulator *regulator, int uV)
{
	if (!regulator)
		return -EINVAL;

	return call_panel_regulator_func(panel, regulator, set_voltage, uV);
}

int panel_regulator_helper_set_current_limit(struct panel_device *panel, struct panel_regulator *regulator, int uA)
{
	if (!regulator)
		return -EINVAL;

	return call_panel_regulator_func(panel, regulator, set_current_limit, uA);
}

int of_get_panel_regulator(struct panel_device *panel, struct device_node *np, struct panel_regulator *regulator)
{
