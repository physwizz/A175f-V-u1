...
#define SEC_TS_DEBUG_PRINT_MOVE_EVENT 0x10
...
/* 16 byte protocol /w displayG. */
struct sec_input_event_coordinate_protocol {
	u8 eid:2;
	u8 tid:4;
	u8 tchsta:2;
	u8 x_11_4;
...
struct sec_ts_coordinate {
	...
	u8 awd;
	u8 fod_debug;
	u8 freq1_noise_level;
	u8 freq2_noise_level;
	u8 freq3_noise_level;
};
